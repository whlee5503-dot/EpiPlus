...
//
// Shared statistical distribution utilities used across EpiPlus modules
// that need chi-square or normal-distribution p-values (e.g. meta-analysis
// heterogeneity tests). Ported from EpiStat's src/lib/statUtils.ts, which
// centralizes this to avoid different modules drifting apart in precision.
